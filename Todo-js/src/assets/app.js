...
function renderTodos(){
    ...
    todos.forEach((todo, index)=>{
        ...
        <button id="task-not-completed" data-id="${index}" class="text-neutral-400 hover:text-violet-500 font-light mt-2 text-sm items-center">Mark as not done</button>
    ...
    let taskNotCompletedBtn = document.querySelectorAll('#task-not-completed');
    ...
    taskNotCompletedBtn.forEach((taskNotCompleted)=>{
